...
void Config::readConfigChar(char c) {
  ...
  if( yr.readChar( c )) {
      ...
      if(yr.line.indent_level==1) if(yml_state==YML_PARAM || yml_state==YML_INIT || yml_state==YML_ACTION ) yml_state=YML_SENSOR;
      ...
      switch(yml_state) {
          ...
          case YML_SENSOR:
              ...
              if( strcmp(yr.line.key,"params")==0) { yml_state = YML_PARAM; }
              break;
      }
